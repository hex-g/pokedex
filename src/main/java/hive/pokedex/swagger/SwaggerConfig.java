...
public class SwaggerConfig extends WebMvcConfigurationSupport {
  ...
  public Docket apiDocumentation() {
    ...
    return new
        ...
        .select()
        .apis(RequestHandlerSelectors.basePackage("hive.pokedex"))
        .build()
  ...
  private ApiInfo metaData() {
    return new
        ApiInfoBuilder()
        .title("Pokédex endpoints")
        .description("\"Hive's user management API\""
            + "\n Repository: https://github.com/hex-g/pokedex"
